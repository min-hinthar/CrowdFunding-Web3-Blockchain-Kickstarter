        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          ...
          <div>
              ...
              <div className='mt-[20px]'>
                <p className='leading-[26px] text-justify font-epilogue font-normal text-[12px] text-[#808191]'>
                    {state.description}
                </p>
              </div>
          </div>
          <div>
            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              ...
              <p className='leading-[26px] text-justify font-epilogue font-normal text-[12px] text-[#808191]'>
                  No donators yet! You can be the first!
              </p>
              )}
            </div>
          </div>
            ...
            <div className='mt-[30px]'>
              ...
              <div className='mt-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                <h4 className='font-epilogue font-semibold text-[14px] leading-[22px] text-white'>
                  Back the campaign because you believe in the cause!
                </h4>
